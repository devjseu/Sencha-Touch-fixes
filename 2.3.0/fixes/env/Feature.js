...
/**
 * @fixes TOUCH-5029
 * This is only source class which is included in all of the Sencha Touch build.
 * To apply fixes from it you need to modify core files like sencha-touch.js etc.
 */
/**
...
Ext.define('Ext.env.Feature', {
    ...
    isStyleSupportedWithoutPrefix: function (name, tag) {
        ...
        if (typeof elementStyle[name] !== 'undefined' &&
            // todo: S.Widelak
            // <TOUCH-5029>
            typeof Ext.browser.getStylePrefix(name) === 'undefined'
        // </TOUCH-5029>
            ) {
            return true;
        }
